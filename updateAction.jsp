...
<body>    
	<%
    	String userID = null;
    		...
    		if (request.getParameter("riveiwTitle") == null || request.getParameter("riveiwContent") == null
    				|| request.getParameter("riveiwTitle").equals("") || request.getParameter("riveiwContent").equals("")) {
    				PrintWriter script = response.getWriter();
    				script.println("<script>");
    				...
    				int result = reveiwDAO.update(riveiwID, request.getParameter("riveiwTitle"),request.getParameter("riveiwContent"));
    				if (result == -1) {
    					PrintWriter script = response.getWriter();
    					script.println("<script>");
