...
<script>
	...
	<div class="container">
		<div class="row">
		<form method="post" action="updateAction.jsp?riveiwID=<%= riveiwID %>">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" name="riveiwTitle" maxlength="50" value="<%= riveiw.getRiveiwTitle() %>"></td>
					</tr>
					<tr>
						<td><textarea class="form-control" placeholder="글 내용" name="riveiwContent" maxlength="2048" style="height: 350px;"><%= riveiw.getRiveiwContent() %></textarea></td>
					</tr>
				</tbody>				
			</table>
			<input type="submit" class="btn2 btn-primary pull-right" value="글수정">
		</form>
		</div>
	</div>
